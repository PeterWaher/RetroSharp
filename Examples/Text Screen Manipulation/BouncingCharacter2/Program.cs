...
// This example builds on BouncingCharacter1, and shows how more advanced scenes can be built
// using direct screen access, and how to interact with objects in the scene.

namespace BouncingCharacter2
{
