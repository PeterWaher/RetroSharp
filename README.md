...
|![Mandelbrot](Images/Mandelbrot_20.png)| The [Mandelbrot](Examples/Raster Graphics/Mandelbrot) project is a homage to Mandelbrot and Julia, and the fractals that bear their names. You can navigate the fractals and smooth them out to create beautiful images. [Full Screen Shot.](Images/Mandelbrot.png) [Executable.](Executables/Mandelbrot.zip) |
