...
|![PeerToPeer](Images/PeerToPeer_20.png)| The [Peer to Peer](Examples/Networking/PeerToPeer) project shows how to allow peers to connect to your application by registering the application in the internet gateway which will allow peers to traverse NAT-enabled firewalls to connect to your application. [Full Screen Shot.](Images/PeerToPeer.png) [Executable.](Executables/PeerToPeer.zip) |
...
|![Mask](Images/Mask_20.png)| The [Mask](Examples/Games/Mask) project implements a version of the classic *Worms* or *Tron* game (Mask is Swedish for Worms), with some extras. The game uses peer-to-peer communication to allow two players to play against each other over the Internet. [Full Screen Shot.](Images/Mask.png) [Executable.](Executables/Mask.zip) |
