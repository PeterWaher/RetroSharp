...
|![PeerToPeer](Images/PeerToPeer_20.png)| The [Peer to Peer](Examples/Networking/PeerToPeer) project shows how to create a simple peer-to-peer network that allows peers to traverse NAT-enabled firewalls and how to connect to peers in the network. [Full Screen Shot.](Images/PeerToPeer.png) [Executable.](Executables/PeerToPeer.zip) |
